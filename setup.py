...
setup(
  ...
  url = 'https://github.com/sanzgiri/robinhood',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/sanzgiri/robinunhood/archive/0.0.4.tar.gz',    # I explain this later on
